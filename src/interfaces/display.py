...
class Displays():
    ...
    def initialize(self, simParam, modelsBus, fswBus, fswModeMgtState):
        ...
        if simParam.runOptions.swVisualPy:
            ...
            # 2.1 AOCS mode
            label_aocsMode = label(pos = vec(0, 0, 0), text = ("MODE: " + fswModeMgtState.aocsMode), xoffset = labelsXoffset, yoffset = labelsYoffset, height = labelsHeight, line = False, box = False)
            ...
            label_angRate_BI_B_X = label(pos = vec(0, 0, 0), text = ("RATE (X): " + ("%.2f" % (angRate_BI_B[0]/deg2rad)) + " deg/s"), xoffset = labelsXoffset, yoffset = labelsYoffset, height = labelsHeight, line = False, box = False)
            labelsYoffset = labelsYoffset - labelsYoffsetDelta
            label_angRate_BI_B_Y = label(pos = vec(0, 0, 0), text = ("RATE (Y): " + ("%.2f" % (angRate_BI_B[1]/deg2rad)) + " deg/s"), xoffset = labelsXoffset, yoffset = labelsYoffset, height = labelsHeight, line = False, box = False)
            labelsYoffset = labelsYoffset - labelsYoffsetDelta
            label_angRate_BI_B_Z = label(pos = vec(0, 0, 0), text = ("RATE (Z): " + ("%.2f" % (angRate_BI_B[2]/deg2rad)) + " deg/s"), xoffset = labelsXoffset, yoffset = labelsYoffset, height = labelsHeight, line = False, box = False)
            labelsYoffset = labelsYoffset - labelsYoffsetDelta
            ...
            label_eulerAng_BI_R = label(pos = vec(0, 0, 0), text = ("ROLL (X): " + ("%.2f" % (eulerAng_BI[0]/deg2rad)) + " deg"), xoffset = labelsXoffset, yoffset = labelsYoffset, height = labelsHeight, line = False, box = False)
            labelsYoffset = labelsYoffset - labelsYoffsetDelta
            label_eulerAng_BI_P = label(pos = vec(0, 0, 0), text = ("PITCH (Y): " + ("%.2f" % (eulerAng_BI[1]/deg2rad)) + " deg"), xoffset = labelsXoffset, yoffset = labelsYoffset, height = labelsHeight, line = False, box = False)
            labelsYoffset = labelsYoffset - labelsYoffsetDelta
            label_eulerAng_BI_Y = label(pos = vec(0, 0, 0), text = ("YAW (Z): " + ("%.2f" % (eulerAng_BI[2]/deg2rad)) + " deg"), xoffset = labelsXoffset, yoffset = labelsYoffset, height = labelsHeight, line = False, box = False)
